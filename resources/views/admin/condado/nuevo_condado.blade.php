...
<div class="container my-5">
        <div class="row">
            <div class="col-12">
                <h1 class="justificado">Nuevo Condado</h1>
            </div>
        </div>
    </div>
    <div class="container">
        ...
        <div class="row justify-content-center mb-5">
            ...
            <div class="col-12 col-md-6 col-xl-4 mx-5 mt-1 mb-3">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= route("condados.store") ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="<?= csrf_token() ?>">
                              
                            <div class="form-group">
                                <label class="justificado" for="nombre">Nombre</label>
                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre del Condado">
                            </div>
